...
const Include = ({ include }: Props) => {
  return (
    <div className="flex flex-col justify-center  bg-[#16364D] py-10 lg:py-24 px-5 lg:px-10 gap-14 text-white">
      <h2 className="uppercase text-center text-[27px] font-light">
        Vad ingår i paketet?
      </h2>
